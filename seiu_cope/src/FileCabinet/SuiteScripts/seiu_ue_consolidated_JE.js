    ...
    function beforeSubmit(context) {
        ...
        if (context.type === context.type) {
          try {
            ...
            var inLineCount = currRecord.getLineCount({
              sublistId: "line",
            });
...
function getJEData(context, inLineCount) {
    var objData = {
      body: {
        id: context.newRecord.id,
        custbody_seiu_sml_scrn_bk_acc: currRecord.getValue({
          fieldId: "custbody_seiu_sml_scrn_bk_acc",
        }),
        subsidiary: currRecord.getValue({
          fieldId: "subsidiary",
        }),
        trandate: currRecord.getValue({
          fieldId: "trandate",
        }),
        custbody23: currRecord.getValue({
          fieldId: "custbody23",
        }), // hader posting group.
        memo: currRecord.getValue({
          fieldId: "memo",
        }),
  
        approver: currRecord.getValue({
          fieldId: "custbody_department_approver",
        }),
  
        tranid: context.newRecord.id,
        jeType: currRecord.getValue({
          fieldId: "custbody_je_type1",
        }),
      },
      line: [],
    ...
    for (var i = 0; i < inLineCount; i++) {
      ...
      objData.line.push({
        custcol_customer: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "custcol_customer",
        }),
        col_entity: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "custcol_cust_bal_vendor",
        }),
        entityType: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "custcol_cust_bal_entity_type",
        }),
  
        debitAmount: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "custcol_sml_bal_amn_deb",
        }),
        creditAmount: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "custcol_sml_bal_amn_cre",
        }),
        department: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "department",
        }),
        lineMemo: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "custcol_seiu_sml_bal_memo_line",
        }),
        cseg1: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "cseg1",
        }),
        cseg2: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "cseg2",
        }),
        cseg3: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "cseg3",
        }),
        cseg4: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "cseg4",
        }),
        cseg_local_code: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "cseg_local_code",
        }),
        location: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "location",
        }),
  
        attachment: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "custcol_primary_attach",
        }),
  
        transactionNo: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "custcol_transactiontype",
        }),
  
        pctType: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "custcol_col_pct_type",
        }),
  
        docDate: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "custcol_document_date",
        }),
  
        account: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
          fieldId: "account",
        }),
  
        transactionType: currRecord.getSublistValue({
          sublistId: "line",
          line: i,
