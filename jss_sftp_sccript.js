...
define(["N/sftp"], function(sftp) {
    ...
    function execute(context) {
        ...
        var contentionObj = sftp.createConnection({
            url: "sftp.adrive.com",
            // keyId: "Fresher@06",
            passwordGuid:"5S57krmZ6A371sSCj3AFKKsOcEQuvHwrYJ8VQSQQQ4w",
            hostKey: "ecdsa-sha2-nistp256 256",
            username: "anuj.maurya@streamssolutions.com",
            directory: "/home/anuj.maurya@streamssolutions.com"
           
        });

        log.debug({
            title: "contentionObj",
            details: contentionObj
        })
    }
